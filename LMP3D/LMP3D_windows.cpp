...
void LMP3D::Windows::setName(const char *name)
{
    SDL_WM_SetCaption("Fury Fighting",NULL);
}

void LMP3D::Windows::setSize(int w,int h)
{
    SDL_SetVideoMode(w,h,24,SDL_OPENGL);
}


void LMP3D::Windows::getEvent()
{
    SDL_Event sevent;
    int i;
...
void LMP3D::Windows::fps(int fps)
{
    int t = 0,slp;
    slp = 1000/fps;
