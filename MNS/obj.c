...
MNS_Model3D *MNS_load_3D_obj( char *nom_du_fichier )
{
	...
	if ( fichier != NULL )
	{
		...
		while ( fgets( chaine, TAILLE_MAX, fichier ) != NULL )
		{
			...
			{
				MNS_lecture_chaine( chaine, ch, 1 );
				va[iv].x = ( float )atof( ch );

				MNS_lecture_chaine( chaine, ch, 2 );
				va[iv].y = ( float )atof( ch );

				MNS_lecture_chaine( chaine, ch, 3 );
				va[iv].z = ( float )atof( ch );
			...
			{
				MNS_lecture_chaine( chaine, ch, 1 );
				vat[ivt].x = ( float )atof( ch );

				MNS_lecture_chaine( chaine, ch, 2 );
				vat[ivt].y = ( float )atof( ch );
			...
			{
				MNS_lecture_chaine( chaine, ch, 1 );
				van[ivn].x = ( float )atof( ch );

				MNS_lecture_chaine( chaine, ch, 2 );
				van[ivn].y = ( float )atof( ch );

				MNS_lecture_chaine( chaine, ch, 3 );
				van[ivn].z = ( float )atof( ch );
